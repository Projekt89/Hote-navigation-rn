...
export const routes = [
  {
    ...
    showInTab: false,
    showInDrawer: false,
      icon: (focused) => <Icon name='home' size={30} color={focused ? '#551E18' : '#000'} />,
  },
  {
  ...
  },
  {
    ...
    showInTab: true,
    showInDrawer: false,
      icon: (focused) => <Icon name='bed' size={30} color={focused ? '#551E18' : '#000'} />,
  },
  {
    name: screens.Book,
    focusedRoute: screens.BookStack,
  ...
  },
  {
    ...
    showInTab: true,
    showInDrawer: false,
      icon: (focused) => <Icon name='phone' size={30} color={focused ? '#551E18' : '#000'} />,
  },
  {
  ...
  },
  {
    ...
    showInTab: false,
    showInDrawer: true,
      icon: (focused) => <Icon name='map-marker' size={30} color={focused ? '#551E18' : '#000'} />,
  },
  {
  ...
  },
  {
    ...
    showInTab: false,
    showInDrawer: true,
      icon: (focused) => <Icon name='star' size={30} color={focused ? '#551E18' : '#000'} />,
  },
  {
